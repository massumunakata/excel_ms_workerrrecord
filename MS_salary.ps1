...
# 2) 対象フォルダ（同じ階層にある「従業員」フォルダ）
# 例: C:\Users\Owner\Desktop\出勤簿\従業員
$baseDir    = "C:\Users\Owner\Desktop\出勤簿"
$folderPath = Join-Path $baseDir "従業員"
...
# 6) 表示（最大10件）
$finalArrays | Select-Object -First 10 | ForEach-Object {
